# Support for Output Descriptors in RBGlobalcoin Core

Since RBGlobalcoin Core v0.17, there is support for Output Descriptors in the
...
on RBGlobalcoin's OP_CHECKMULTISIG opcode. To support these, we introduce the
...
existing RBGlobalcoin Core wallets, a convenience function `combo` is
