...
"""Verify that starting rbglobalcoin with -h works as expected."""
import subprocess
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start rbglobalcoin with -h for help text")
        ...
        self.log.info("Start rbglobalcoin with -version for version information")
