...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s rbglobalcoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  rbglobalcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded rbglobalcoin transaction") + "\n" +
              "  rbglobalcoin-tx [options] -create [commands]   " + _("Create hex-encoded rbglobalcoin transaction") + "\n" +
              "\n";
