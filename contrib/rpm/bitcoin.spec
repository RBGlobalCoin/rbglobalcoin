...
%{_sbindir}/semanage port -a -t bitcoin_port_t -p tcp 7621
%{_sbindir}/semanage port -a -t bitcoin_port_t -p tcp 7622
%{_sbindir}/semanage port -a -t bitcoin_port_t -p tcp 17621
%{_sbindir}/semanage port -a -t bitcoin_port_t -p tcp 17622
...
if [ $1 -eq 0 ]; then
	if [ `%{_sbindir}/sestatus |grep -c "disabled"` -eq 0 ]; then
	%{_sbindir}/semanage port -d -p tcp 7621
	%{_sbindir}/semanage port -d -p tcp 7622
	%{_sbindir}/semanage port -d -p tcp 17621
	%{_sbindir}/semanage port -d -p tcp 17622
